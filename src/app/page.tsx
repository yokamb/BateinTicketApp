...
export default async function LandingPage() {
  ...
  return (
    <div className="min-h-screen text-[#0d0d0d] selection:bg-indigo-100 overflow-hidden font-sans antialiased relative">
      {/* Absolute Base Layer: White Background */}
      <div className="fixed inset-0 z-[-2] bg-white"></div>
      
      {/* Absolute Middle Layer: Tech Pattern Background */}
      <div 
      ...
      <nav className="fixed top-0 w-full z-50 bg-transparent border-none">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-14 sm:h-16 flex items-center justify-between bg-transparent">

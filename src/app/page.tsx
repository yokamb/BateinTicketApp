...
export default async function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-[#0d0d0d] selection:bg-indigo-100 overflow-hidden font-sans antialiased relative">
      ...
      <div className="absolute top-[-15%] left-[-10%] w-[600px] h-[600px] bg-indigo-500/20 rounded-full blur-[120px] pointer-events-none animate-pulse-subtle"></div>
      <div className="absolute top-[20%] right-[-15%] w-[500px] h-[500px] bg-blue-500/15 rounded-full blur-[100px] pointer-events-none animate-cloud-morph delay-1"></div>
      <div className="absolute bottom-[-10%] left-[10%] w-[600px] h-[600px] bg-purple-500/15 rounded-full blur-[130px] pointer-events-none animate-cloud-morph delay-2"></div>
      ...
      <main className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 pt-24 sm:pt-32 pb-16 sm:pb-24 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
          <Link href={session ? "/dashboard" : "/register"} className="w-full sm:w-auto px-6 sm:px-8 py-3.5 sm:py-4 bg-gradient-to-r from-indigo-600 to-blue-500 rounded-2xl text-white font-bold text-base sm:text-lg hover:shadow-2xl hover:shadow-indigo-500/40 transition-all flex items-center justify-center gap-2 group shadow-xl shadow-indigo-500/20 hover:scale-[1.02] active:scale-[0.98]">
            {session ? "Enter Workspace" : "Start Free Trial"}
            <ArrowRight className="group-hover:translate-x-1 transition-transform" size={20} />
          </Link>
          <Link href="#features" className="w-full sm:w-auto px-6 sm:px-8 py-3.5 sm:py-4 bg-white border border-[#eceef0] hover:border-indigo-200 hover:bg-slate-50 rounded-2xl text-[#0d0d0d] font-bold text-base sm:text-lg transition-all shadow-[0_2px_8px_rgba(0,0,0,0.04)] hover:shadow-[0_4px_12px_rgba(0,0,0,0.06)]">
            View Features
          </Link>
        </div>
      </main>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {[
              ...
              <div key={i} className="p-6 sm:p-8 rounded-[2rem] bg-white border border-[#eceef0] shadow-[0_2px_8px_rgba(0,0,0,0.04)] hover:shadow-[0_8px_24px_rgba(0,0,0,0.08)] hover:-translate-y-1 transition-all duration-300 group relative overflow-hidden">
                ...
                <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-[#1a1a1a]">{f.title}</h3>
                <p className="text-[#475467] text-sm leading-relaxed font-medium">{f.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="pricing" className="relative z-10 py-16 sm:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 max-w-5xl mx-auto">
            {/* Free */}
            <div className="p-7 sm:p-10 rounded-[2rem] bg-white border border-[#eceef0] shadow-[0_2px_8px_rgba(0,0,0,0.04)] flex flex-col hover:shadow-[0_8px_24px_rgba(0,0,0,0.08)] transition-all group">
               <h3 className="text-xl font-bold text-[#475467] mb-1">Free</h3>
               <div className="text-4xl font-black text-[#1a1a1a] mb-6 sm:mb-8 font-mono tracking-tighter">$0<span className="text-sm text-[#667085] font-medium">/mo</span></div>
               <ul className="space-y-3 sm:space-y-4 mb-8 sm:mb-10 text-[#475467] text-[13px] font-medium border-t border-[#f0f2f5] pt-6">
                  ...
                  <li className="flex items-center gap-3 text-indigo-600 font-bold bg-indigo-50/50 p-1.5 -ml-1.5 rounded-lg"><CheckCircle size={16} className="text-indigo-500 shrink-0"/> Universal Time Tracker</li>
               ...
               <Link href={session ? "/dashboard" : "/register"} className="mt-auto block w-full text-center py-3.5 rounded-2xl bg-[#f8f9fa] border border-[#eceef0] hover:bg-slate-50 text-[#1a1a1a] font-bold transition-all text-sm shadow-sm">
                 {session ? "Dashboard" : "Get Started"}
               </Link>
            </div>

            {/* Pro */}
            <div className="p-7 sm:p-10 rounded-[2rem] bg-white border-2 border-indigo-500 flex flex-col shadow-[0_12px_32px_rgba(79,70,229,0.15)] relative md:scale-105 z-10">
               <div className="absolute -top-4 left-1/2 -translate-x-1/2 px-5 py-1.5 bg-gradient-to-r from-indigo-600 to-blue-500 text-white text-[11px] font-black rounded-full shadow-lg">MOST POPULAR</div>
               <h3 className="text-xl font-bold text-indigo-600 mb-1">Pro</h3>
               <div className="text-4xl font-black text-[#1a1a1a] mb-6 sm:mb-8 font-mono tracking-tighter">$2<span className="text-sm text-[#667085] font-medium">/mo</span></div>
               <ul className="space-y-3 mb-8 sm:mb-10 text-[#475467] text-[12px] font-medium border-t border-indigo-50 pt-6">
                  ...
                  <li className="flex items-center gap-3 text-indigo-600 font-bold bg-indigo-50/50 p-1.5 -ml-1.5 rounded-lg"><CheckCircle size={16} className="text-indigo-500 shrink-0"/> Enhanced Analytics (30d)</li>
               ...
               <Link href={session ? "/dashboard" : "/register"} className="mt-auto block w-full text-center py-4 rounded-2xl bg-gradient-to-r from-indigo-600 to-blue-500 hover:shadow-xl hover:shadow-indigo-500/30 text-white font-bold transition-all text-sm">
                 {session ? "Upgrade Now" : "Get Pro Now"}
               </Link>
            </div>

            {/* Max */}
            <div className="p-7 sm:p-10 rounded-[2rem] bg-white border border-[#eceef0] shadow-[0_2px_8px_rgba(0,0,0,0.04)] flex flex-col hover:shadow-[0_8px_24px_rgba(0,0,0,0.08)] transition-all">
               <h3 className="text-xl font-bold text-[#475467] mb-1">Max</h3>
               <div className="text-4xl font-black text-[#1a1a1a] mb-6 sm:mb-8 font-mono tracking-tighter">$6<span className="text-sm text-[#667085] font-medium">/mo</span></div>
               <ul className="space-y-3 mb-8 sm:mb-10 text-[#475467] text-[11px] font-medium border-t border-[#f0f2f5] pt-6">
               ...
               <Link href={session ? "/dashboard" : "/register"} className="mt-auto block w-full text-center py-3.5 rounded-2xl bg-[#f8f9fa] border border-[#eceef0] hover:bg-slate-50 hover:text-emerald-600 text-[#1a1a1a] font-bold transition-all text-sm shadow-sm">
      ...
      <section className="relative z-10 py-32 bg-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-3xl md:text-5xl font-black mb-8 text-[#1a1a1a] tracking-tight leading-tight">Ready to elevate your <br /> <span className="bg-gradient-to-r from-indigo-600 to-blue-500 bg-clip-text text-transparent">client experience?</span></h2>
          <Link href="/register" className="inline-flex items-center gap-3 px-10 py-5 bg-[#0d0d0d] text-white rounded-[2rem] font-black text-xl hover:bg-[#1a1a1a] hover:shadow-2xl hover:shadow-black/20 transition-all hover:scale-105 active:scale-95 shadow-xl">
            Get Started For Free
            <ArrowRight size={22} />
          </Link>
          <p className="mt-6 text-[#667085] text-sm font-bold uppercase tracking-widest">No credit card required</p>
        </div>
      </section>

      {/* Footer */}
      <footer className="py-16 border-t border-[#f0f2f5] bg-white text-center relative overflow-hidden">
        ...
        {/* Vibrant Footer Blob */}
        <div className="absolute bottom-[-20%] left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-blue-500/10 rounded-[100%] blur-[100px] pointer-events-none animate-pulse-subtle"></div>
      </footer>
    </div>
  );
}